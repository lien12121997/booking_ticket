        ...
        <div class="row">
          <div class="col-md-7 col-lg-7">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="support" type="text"/>
            </div>
            <div class="form-group">
                <div class="product-title">Slogan *</div>
                <textarea class="form-control" name="slogan" rows="3px"></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="fanpage" type="text"/>
            </div>
          </div>
