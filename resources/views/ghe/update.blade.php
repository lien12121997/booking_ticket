...
<div class="content col-md-9">
  ...
  <h1 class="head--title">Cập Nhật Loại Ghế</h1>
        ...
        <div class="row">
          <div class="col-md-12 col-lg-9">
              <div class="form-group">
                  ...
                  <input class="form-control" name="name" placeholder="Enter Name" value="{{$ghe -> name}}" />
              </div>
              <div class="form-group">
                  <div class="product-title">Price</div>
                  <input class="form-control" name="price" placeholder="Enter Name" value="{{$ghe -> price}}" />
              </div>
